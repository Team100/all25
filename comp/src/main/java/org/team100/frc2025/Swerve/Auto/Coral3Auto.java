...
public class Coral3Auto extends SequentialCommandGroup100 {
    public Coral3Auto(
        ...
        addCommands(
                ...
                // First Coral
                new ParallelCommandGroup100( //to drive to reef
                        logger,
                        new Embark(
                                m_drive,
                                heedRadiusM,
                ...
                new ScoreL4(logger, wrist, elevator), //to score

                // Second Coral
                new ParallelRaceGroup( // NAVIGATOR DOSENT END? CHECK LOGS
                        new WaitCommand(3), //gives max 3 seconds to drive there
                        new GoToCoralStation(
                                ...
                                0.5),
                        new RunFunnelHandoff(logger, elevator, wrist, funnel, tunnel, grip)),
                new ParallelRaceGroup( //why is this here?
                        new WaitCommand(0.1),
                        new RunFunnelHandoff(logger, elevator, wrist, funnel, tunnel, grip)),
                ...
                new ParallelRaceGroup( // NAVIGATOR DOSENT END? CHECK LOGS
                        new WaitCommand(3), //gives max 3 seconds to drive there
                        new GoToCoralStation( //goes get coral
                                logger,
                                m_drive,
                                controller,
                                viz,
                ...
                //things that make us slow: flip out then raise, seem slow to drive, elevator not while driving
